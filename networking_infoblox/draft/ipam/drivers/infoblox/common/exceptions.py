...
class InfobloxGridSyncError(exceptions.NeutronException):
    message = _("Grid sync error: %(msg)s")


class InfobloxMemberReservationError(exceptions.NeutronException):
    message = _("Member reservation error: %(msg)s")
