...
class InfobloxPool(subnet_alloc.SubnetAllocator):
    ...
    def get_subnet(self, subnet_id):
        ...
        if ib_network:
            return InfobloxSubnet(self._context, subnet_request,
                                  neutron_subnet, ib_network, ib_context)
...
class InfobloxSubnet(driver.Subnet):
    ...
    def __init__(self, context, subnet_details, neutron_subnet, ib_network,
                 ib_context):
    ...
    def deallocate(self, address):
        ...
        mapped_netview = self._ib_context.mapping.network_view
        ...
        address_request = self._build_address_request_from_ib_address(fa)
        ...
        hostname = None
        dns_controller.unbind_names(ip_address,
                                    hostname,
                                    address_request.port_id,
                                    address_request.tenant_id,
                                    address_request.device_id,
    ...
    def _build_address_request_from_ib_address(self, ib_address):
