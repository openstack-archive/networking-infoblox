...
GRID_CONFIG_DEFAULTS = {
    ...
    EA_GRID_CONFIG_IP_ALLOCATION_STRATEGY: IP_ALLOCATION_STRATEGY_HOST_RECORD,
    EA_GRID_CONFIG_DNS_RECORD_BINDING_TYPES: [],
    EA_GRID_CONFIG_DNS_RECORD_UNBINDING_TYPES: [],
    EA_GRID_CONFIG_DNS_RECORD_REMOVABLE_TYPES: [],
