...
ipam_opts = [
    ...
    cfg.IntOpt('cloud_data_center_id',
               help=_("ID of cloud data center to connect")),
    ...
    cfg.ListOpt('unbind_dns_records_from_fixed_address',
                ...
                help=_("List of DNS records to unbind from "
                       "a fixed address during IP de-allocation.")),
...
dc_opts = [
    ...
    cfg.StrOpt('wapi_version',
               help=_("WAPI version.")),
    cfg.IntOpt('wapi_http_pool_connections',
               default=100,
               help=_("HTTP pool connection.")),
    cfg.IntOpt('wapi_http_pool_maxsize',
               default=100,
               help=_("HTTP pool max size.")),
    cfg.IntOpt('wapi_http_request_timeout',
               default=120,
