...
class HttpClient(object):
    ...
    def _parse_options(self, options):
        ...
        self.ssl_verify = options.wapi_ssl_verify
        self.http_pool_connections = options.wapi_http_pool_connections
        self.http_pool_maxsize = options.wapi_http_pool_maxsize
        self.request_timeout = options.wapi_http_request_timeout
