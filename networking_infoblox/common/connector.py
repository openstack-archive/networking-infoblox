...
class InfobloxWAPIClient(object):
    """InfobloxClient is client for intreacting with to Infoblox NIOS
    ...
    def _parse_options(self, options):
        # Simplified connector options for now
        self.wapi_url = options.wapi_url
        self.cloud_api_enabled = False
        self.username = options.username
        self.password = options.password

        self.ssl_verify = options.ssl_verify
        self.http_pool_connections = options.http_pool_connections
        self.http_pool_maxsize = options.http_pool_maxsize
        self.request_timeout = options.http_request_timeout
    ...
    def get_object(self, obj_type, payload=None, return_fields=None,
        ...
        - the first one is not proxied to GM 	161
        ...
        # Don't set proxy flag if wapi version is too old (non-cloud)
