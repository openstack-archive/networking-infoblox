...
To start it manually, without any init.d or systemd setup, you use the
...
Nova
----
If you modified the Nova notification settings, you should restart the Nova
*<<<which service???>>>>* on each node running it. The exact command may vary
based on your distribution. In Ubuntu the command is::
