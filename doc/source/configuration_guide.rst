...
All of thee EAs below are set on the grid master object.
...
In the case of the GM, if it is not configured and licensed for DNS or DHCP,
set `Use Grid Master for DHCP` EA to False. This will exclude the GM from
being selected to serve DHCP or DHCP.
