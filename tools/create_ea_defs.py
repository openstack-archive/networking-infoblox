...
print("Superuser authority is required.\n")
print("If the preconfigured credentials already has Superuser authrority,")
print("just hit <ENTERY> when prompted for user name.\n")
print("Otherwise, please enter user name and password of Superuser \
when prompted.\n")
